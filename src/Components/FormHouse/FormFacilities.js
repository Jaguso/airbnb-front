    ...
    return (
      <div>
        <div className="form-group" >
          ...
          <select name="size" className="form-control" value={this.state.size} onChange={this.onChangeInput}>
        ...
        <div className="form-group">
          ...
          <input type="number" name="garage" className="form-control" 
            value={this.state.garage} onChange={this.onChangeInput}
          />
        </div>
        ...
        <div className="form-group">
          ...
          <input type="checkbox" name="pet_friendly" className="form-control" 
            checked={this.state.pet_friendly} onChange={this.onCheckInput}
          />
        </div>
        ...
        <div className="form-group">
          ...
          <input type="checkbox" name="smoke_friendly" className="form-control" 
            checked={this.state.smoke_friendly} onChange={this.onCheckInput}
          />
        </div>
        ...
        <div className="form-group">
          ...
          <input type="checkbox" name="tv" className="form-control" 
            checked={this.state.tv} onChange={this.onCheckInput}
          />
        </div>
        ...
        <div className="form-group">
          ...
          <input type="checkbox" name="wifi" className="form-control" 
            checked={this.state.wifi} onChange={this.onCheckInput}
          />
        </div>
        ...
        <div className="form-group">
          ...
          <input type="checkbox" name="kitchen" className="form-control" 
            checked={this.state.kitchen} onChange={this.onCheckInput}
          />
        </div>
      </div>
    )
