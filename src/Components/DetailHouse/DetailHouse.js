...
class DetailHouse extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      house: {},
      id: props.match.params.id, //esto es para traer el id del usuario del Url
      isLoading: true,
      sizes: {
        "S": "Chico",
        "M": "Mediano",
  ...
  //lo siguiente quiere decir: una vez que se haya renderizado el componente, se ejecuta esto
  componentDidMount() {
    //llamada a la api
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              <ul>
                ...
                {(house.facilities.pet_friendly) ? <li>Acepta Nascotas</li> : <div></div>}
                ...
                {(house.facilities.kitchen !== 0) ? <li>Tiene cocina</li> : <div></div>}
              </ul>
            </div>
          </div>
          <h6>Imágenes:</h6>
