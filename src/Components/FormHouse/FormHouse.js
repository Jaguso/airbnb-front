          ...
          <form onSubmit={this.formSubmit}>
            ...
            <div className="form-group">
              ...
              <select name="type" className="form-control" 
                value={this.state.type} onChange={this.onChangeInput}
              >
            ...
            <div className="form-group">
              <label className="btn btn-info">
                ...
                <FileUploader 
                  ...
                  randomizeFilename
                  multiple
                  storageRef={Firebase.storage().ref('houses')}
            ...
            <button type="submit" className="btn btn-success">Guardar casa </button>
